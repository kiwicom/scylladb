...
db::config::config(std::shared_ptr<db::extensions> exts)
    ...
    , max_pending_applies(this, "max_pending_applies", value_status::Used, 10000, "Maximum number of pending gossip applies per shard. Gossip messages above this limit will be discarded.")
